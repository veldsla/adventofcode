...
fn main() {
    ...
    computer.registers.set(Register('a'), 7);
    computer.run_program();
    println!("The value in register a is {}", computer.registers.get(Register('a')));

    println!("Resetting and setting register a to 12");
    computer.reset();
    computer.registers.set(Register('a'), 12);
    computer.run_program();
...
";    
    ...
    c.run_program();
    assert_eq!(c.registers.get(Register('a')), 3);
}
