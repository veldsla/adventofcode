const INPUT: [u8; 16] = [225,171,131,2,35,5,0,13,1,246,54,97,255,98,254,110];
const INPUT_STR: &'static str = "225,171,131,2,35,5,0,13,1,246,54,97,255,98,254,110";
...
fn main() {
    println!("Hash output 10a = {}", rearrange(&INPUT, 1).0);
    println!("Hash output 10b = {}", knot_hash(&INPUT_STR));
}
